...
- **Data Ingestion Automation:** Move away from manual CSV seeding. Implement scripts to fetch and process new scientific data (TESS/Mars) directly into PocketBase.
...
- **Database Optimization:** Review and tune PocketBase collection rules and indexes for anomaly and submission collections to ensure high performance as the dataset grows.
...
4. **task-49d38s:** Optimize PocketBase collection rules and query performance
