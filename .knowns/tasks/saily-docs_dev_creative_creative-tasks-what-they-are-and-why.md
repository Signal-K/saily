...
description: 'Overview of all open creative tasks across Saily and Planet Hunters: who they''re for, what unblocks, and what format output should take'
createdAt: '2026-03-30T11:45:40.854Z'
updatedAt: '2026-05-13T08:07:52.828Z'
tags:
  - project-saily
  - doc-kind-review
  - creative
...
The codebase has systems that render content — dialogue, UI copy, reward screens, celebration moments — but the *content itself* hasn't been written. These tasks are placeholders or gaps that show up as empty strings, placeholder text, or TODO comments in the code.
...
| `2pqc1e` | Draft chapter outlines for Story Arc 2 | Arc 2 content |
| `wnmktw` | Write mission control helper copy for puzzle actions | In-game UX guidance |
| `8rv9kf` | Design arc-complete celebration moment + reward screen spec | Reward moment UX |
...
| `ps6nfy` | Design the SR2 unlock celebration moment | ✓ Done |
